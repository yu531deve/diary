...
自作の大学院入試(理工系: 工学・情報・物理系)数学問題を公開する静的サイト。原稿は LaTeX、成果物は Web ページ(HTML)と印刷用 PDF。
...
- **理工系大学院入試を想定した 8 分野**: 微分積分学・線形代数・複素解析・常微分方程式・偏微分方程式/積分変換・ベクトル解析・確率統計・数値解析/離散数学(詳細は [fields.yaml](fields.yaml))
